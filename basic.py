...
# https://docs.nvidia.com/nim/riva/asr/latest/getting-started.html#launching-the-nim
import io
...
# Save to file
with open(f"output/basic - {datetime.now().timestamp()}.json", 'w', encoding='utf-8') as f:
